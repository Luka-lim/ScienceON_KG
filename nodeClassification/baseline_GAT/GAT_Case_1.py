...
for roundIDX in range(1, rounds):
    for testsize in testsizes:
        ...
        # Define Model
        model = GAT(data.num_features, hidden_channels=hidden_channel, out_channels=num_classes, heads=head)
    ...
    dfMicro.to_csv('./model/GAT_micro_1_1_1.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_1_1.csv', encoding='utf-8-sig', index=False)
...
for roundIDX in range(1, rounds):
    ...
    dfMicro.loc[roundIDX] = data_micro
    dfMacro.loc[roundIDX] = data_macro
    dfMicro.to_csv('./model/GAT_micro_1_1_2.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_1_2.csv', encoding='utf-8-sig', index=False)
...
for roundIDX in range(1, rounds):
    ...
    dfMicro.loc[roundIDX] = data_micro
    dfMacro.loc[roundIDX] = data_macro
    dfMicro.to_csv('./model/GAT_micro_1_2_1.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_2_1.csv', encoding='utf-8-sig', index=False)
...
for roundIDX in range(1, rounds):
    ...
    dfMicro.loc[roundIDX] = data_micro
    dfMacro.loc[roundIDX] = data_macro
    dfMicro.to_csv('./model/GAT_micro_1_2_2.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_2_2.csv', encoding='utf-8-sig', index=False)
...
for roundIDX in range(1, rounds):
    ...
    dfMicro.loc[roundIDX] = data_micro
    dfMacro.loc[roundIDX] = data_macro
    dfMicro.to_csv('./model/GAT_micro_1_3_1.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_3_1.csv', encoding='utf-8-sig', index=False)
...
for roundIDX in range(1, rounds):
    ...
    dfMicro.loc[roundIDX] = data_micro
    dfMacro.loc[roundIDX] = data_macro
    dfMicro.to_csv('./model/GAT_micro_1_3_2.csv', encoding='utf-8-sig', index=False)
    dfMacro.to_csv('./model/GAT_macro_1_3_2.csv', encoding='utf-8-sig', index=False)
