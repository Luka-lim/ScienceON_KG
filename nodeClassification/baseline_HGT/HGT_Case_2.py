...
for roundIDX in range(1, rounds):
    ...
    data.__delitem__(('patent'))
    data.__delitem__(('ipc'))
    data.__delitem__(('report'))
    data.__delitem__(('report', 'cites', 'copaper'))
    data.__delitem__(('copaper', 'cites', 'report'))
    data.__delitem__(('report', 'cites', 'paper'))
    data.__delitem__(('paper', 'cites', 'report'))
    data.__delitem__(('patent', 'results_from', 'project'))
    data.__delitem__(('project', 'results_from', 'patent'))
    data.__delitem__(('patent', 'is_classified', 'ipc'))
    data.__delitem__(('ipc', 'is_classified', 'patent'))
    data.__delitem__(('report', 'results_from', 'project'))
    data.__delitem__(('project', 'results_from', 'report'))
    data.__delitem__(('author', 'writes', 'patent'))
    data.__delitem__(('patent', 'writes', 'author'))
    data.__delitem__(('author', 'writes', 'report'))
    data.__delitem__(('report', 'writes', 'author'))
    data.__delitem__(('organ', 'writes', 'patent'))
    data.__delitem__(('patent', 'writes', 'organ'))
    data.__delitem__(('organ', 'writes', 'report'))
    data.__delitem__(('report', 'writes', 'organ'))
    print(data)
    ...
    for testsize in testsizes:
        ...
        file = open("./case2/model_HGT_Case_save_2_1_1_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    for testsize in testsizes:
        print('Test Size: ', testsize)
        file = open("./case2/model_HGT_Case_save_2_1_2_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    data.__delitem__(('paper', 'cites', 'paper'))
    data.__delitem__(('paper', 'cites', 'copaper'))
    data.__delitem__(('copaper', 'cites', 'paper'))
    data.__delitem__(('paper', 'published_in', 'journal'))
    data.__delitem__(('journal', 'published_in', 'paper'))
    data.__delitem__(('paper', 'results_from', 'project'))
    data.__delitem__(('project', 'results_from', 'paper'))
    data.__delitem__(('report', 'results_from', 'project'))
    data.__delitem__(('project', 'results_from', 'report'))
    data.__delitem__(('report', 'cites', 'paper'))
    data.__delitem__(('paper', 'cites', 'report'))
    data.__delitem__(('report', 'cites', 'copaper'))
    data.__delitem__(('copaper', 'cites', 'report'))
    data.__delitem__(('author', 'writes', 'paper'))
    data.__delitem__(('paper', 'writes', 'author'))
    data.__delitem__(('author', 'writes', 'report'))
    data.__delitem__(('report', 'writes', 'author'))
    data.__delitem__(('organ', 'writes', 'paper'))
    data.__delitem__(('paper', 'writes', 'organ'))
    data.__delitem__(('organ', 'writes', 'report'))
    data.__delitem__(('report', 'writes', 'organ'))
    data.__delitem__(('paper'))
    data.__delitem__(('copaper'))
    data.__delitem__(('journal'))
    data.__delitem__(('report'))
    data.__delitem__(('report', 'cites', 'copaper'))
    data.__delitem__(('copaper', 'cites', 'report'))
    ...
    for testsize in testsizes:
        print('Test Size: ', testsize)
        file = open("./case2/model_HGT_Case_save_2_2_1_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    for testsize in testsizes:
        print('Test Size: ', testsize)
        file = open("./case2/model_HGT_Case_save_2_2_2_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    for testsize in testsizes:
        print('Test Size: ', testsize)
        file = open("./case2/model_HGT_Case_save_2_3_1_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    for testsize in testsizes:
        print('Test Size: ', testsize)
        file = open("./case2/model_HGT_Case_save_2_3_2_" + str(testsize) + '_' + str(roundIDX) + ".txt", "wt")
    ...
    micro_1_1_1.to_csv('./case2/HGT_micro_2_1_1.csv', encoding='utf-8-sig', index=False)
    macro_1_1_1.to_csv('./case2/HGT_macro_2_1_1.csv', encoding='utf-8-sig', index=False)
    micro_1_1_2.to_csv('./case2/HGT_micro_2_1_2.csv', encoding='utf-8-sig', index=False)
    macro_1_1_2.to_csv('./case2/HGT_macro_2_1_2.csv', encoding='utf-8-sig', index=False)
    micro_1_2_1.to_csv('./case2/HGT_micro_2_2_1.csv', encoding='utf-8-sig', index=False)
    macro_1_2_1.to_csv('./case2/HGT_macro_2_2_1.csv', encoding='utf-8-sig', index=False)
    micro_1_2_2.to_csv('./case2/HGT_micro_2_2_2.csv', encoding='utf-8-sig', index=False)
    macro_1_2_2.to_csv('./case2/HGT_macro_2_2_2.csv', encoding='utf-8-sig', index=False)
    micro_1_3_1.to_csv('./case2/HGT_micro_2_3_1.csv', encoding='utf-8-sig', index=False)
    macro_1_3_1.to_csv('./case2/HGT_macro_2_3_1.csv', encoding='utf-8-sig', index=False)
    micro_1_3_2.to_csv('./case2/HGT_micro_2_3_2.csv', encoding='utf-8-sig', index=False)
    macro_1_3_2.to_csv('./case2/HGT_macro_2_3_2.csv', encoding='utf-8-sig', index=False)
